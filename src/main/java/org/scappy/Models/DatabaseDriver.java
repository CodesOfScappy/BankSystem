...
/**
 * DatabaseDriver Klasse: Diese Klasse ist für alle Datenbank-Operationen verantwortlich
 *
 *
 * @autor CodeOfScappy
 */
public class DatabaseDriver {
    ...
    //###############
    /**
     * Methode für das Abrufen von Client Daten aus der Datenbank
     * @param pAddress
     * @param password
     */
    ...
    public ResultSet getTransactions(String pAddress,int limit){
        ...
        try{
            ...
            // Testing SQL-Statement (LIMIT)
            System.out.println("Test: getTransaction-Method: --> SQL-Statement Successfully Executed");
        }catch(SQLException e){
            e.printStackTrace();
        }
        return resultSet;
    ...
    /**
     * Methoden zum Addieren oder Subtrahieren von Balance-Vorgängen
     * @param pAddress
     * @param amount
     * @param operation
     *
    ...
    /**
     * Methode zum Erstellen einer neuen Transaction und speichern in der Datenbank
     * @param sender
     * @param receiver
     * @param amount
     * @param message
    ...
    public void newTransaction(String sender, String receiver, double amount, String message){
        ...
        try{
            ...
            //TODO: Testing SQL-Statement newTransaction (INSERT)
            System.out.println("Test: newTransaction-Method: --> SQL-Statement Successfully Executed");
        }catch(SQLException e){
            e.printStackTrace();
        }
    }
    ...
    //###############
    /**
     * Methode für das Abrufen von Admin Daten aus der Datenbank
     * @param username
     * @param password
     */
    ...
    /**
     * Methode für das Abrufen von CheckingAccount Daten aus der Datenbank
     * @param owner
     * @param number
     * @param tLimit
     * @param balance
    ...
    public void depositSavings(String pAddress, double newBalance){
        Statement statement;
        try{
            statement = this.conn.createStatement();
            statement.executeUpdate("UPDATE SavingsAccounts SET Balance = Balance + 1000 WHERE Owner = '"+pAddress+"';");
        }catch(SQLException e){
            e.printStackTrace();
        }
    }
    ...
    /**
     * Methode zum Suchen von Client Daten aus der Datenbank
     * @param pAddress
     */
